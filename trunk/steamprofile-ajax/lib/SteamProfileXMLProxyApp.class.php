...
class SteamProfileXMLProxyApp {
	...
	public function setConnectTimeout($iConnectTimeout) {
		$this->iConnectTimeout = (int)$iConnectTimeout;
	}
	...
	public function run() {
		try {
			...
			if(!$CacheEntry->isCached()) {
				$cURL = new SteamProfileDownloader($sXMLUrl, self::VERSION, $this->iConnectTimeout);
